...
void main() {
  group('EncryptedDirectMessage', () {
    test('EncryptedDirectMessage.redact', () {
      ...
      EncryptedDirectMessage event =
          EncryptedDirectMessage.redact(bobPrivkey, alicePubkey, plaintext);

      expect(event.receiver, alicePubkey);
    ...
    test('EncryptedDirectMessage.receive', () {
      ...
      EncryptedDirectMessage event = m.message;
      expect(event.id,
      ...
      String content = event.getPlaintext(bobPrivkey);
